class Employee:
    ...
    def salary(self, new_salary):
        ...
        if hasattr(self, '_level') and new_salary < Employee._base_salary[self.level]:
            raise ValueError(f'Salary must be higher than minimum salary ${Employee._base_salary[self.level]}.')
